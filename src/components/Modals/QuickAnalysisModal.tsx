  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-xs p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-2xl bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-bold text-slate-900">Lente de Análise Rápida</h3>
                <span className="px-2 py-0.5 text-xs font-mono font-bold rounded-md bg-emerald-50 text-emerald-800 border border-emerald-200">
                  CTRL + Q
                </span>
              </div>
              <p className="text-xs text-slate-500">
                Intervalo selecionado: <span className="font-mono text-slate-800 font-bold">{rangeAddress}</span> ({numericValues.length} números)
              </p>
            </div>
          </div>
        ...
        {/* Tabs Bar */}
        <div className="flex border-b border-slate-200 bg-slate-100/70 px-4">
          <button
            ...
            <div className="space-y-4">
              {numericValues.length === 0 ? (
                <div className="p-3.5 rounded-xl bg-amber-50 border border-amber-200 text-amber-950 text-xs flex items-start gap-2.5">
                  ...
                  <div>
                    <div className="font-bold">Onde as Barras de Dados e Cores aparecem?</div>
                ...
                <div className="p-2.5 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-950 text-[11px] flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 hover:border-emerald-400 transition-all text-left cursor-pointer group"
                >
                  <div className="w-10 h-8 rounded bg-slate-200 flex flex-col justify-center gap-1 p-1">
                    <div className="h-1.5 w-3/4 bg-emerald-600 rounded-xs"></div>
                    <div className="h-1.5 w-1/2 bg-emerald-600 rounded-xs"></div>
                    <div className="h-1.5 w-full bg-emerald-600 rounded-xs"></div>
                  </div>
                  <div>
                    <div className="text-xs font-bold text-slate-800 group-hover:text-emerald-700">Barras de Dados</div>
                    <div className="text-[11px] text-slate-500">Gradiente proporcional ao valor</div>
                  </div>
                </button>
                ...
                <button
                  ...
                  className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 hover:border-emerald-400 transition-all text-left cursor-pointer group"
                >
                  <div className="w-10 h-8 rounded flex overflow-hidden border border-slate-300">
                    <div className="w-1/3 h-full bg-emerald-300"></div>
                    <div className="w-1/3 h-full bg-amber-300"></div>
                    <div className="w-1/3 h-full bg-rose-300"></div>
                  </div>
                  <div>
                    <div className="text-xs font-bold text-slate-800 group-hover:text-emerald-700">Escala de Cores (Calor)</div>
                    <div className="text-[11px] text-slate-500">Verde (alto), Amarelo, Vermelho (baixo)</div>
                  </div>
                </button>
                ...
                <button
                  ...
                  className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 hover:border-emerald-400 transition-all text-left cursor-pointer group"
                >
                  <div className="w-10 h-8 rounded bg-slate-100 flex items-center justify-center gap-1 border border-slate-200">
                    <span className="size-2 rounded-full bg-emerald-600"></span>
                    <span className="size-2 rounded-full bg-amber-500"></span>
                    <span className="size-2 rounded-full bg-rose-500"></span>
                  </div>
                  <div>
                    <div className="text-xs font-bold text-slate-800 group-hover:text-emerald-700">Conjunto de Ícones</div>
                    <div className="text-[11px] text-slate-500">Semáforos de status</div>
                  </div>
                </button>
                ...
                <button
                  ...
                  className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 hover:border-emerald-400 transition-all text-left cursor-pointer group"
                >
                  <div className="w-10 h-8 rounded bg-emerald-100 border border-emerald-300 flex items-center justify-center text-xs font-bold text-emerald-800">
                    &gt; X̄
                  </div>
                  <div>
                    <div className="text-xs font-bold text-slate-800 group-hover:text-emerald-700">Acima da Média</div>
                    <div className="text-[11px] text-slate-500">Realçar valores superiores a {previewAvg.toFixed(1)}</div>
                  </div>
                </button>
              </div>
            </div>
          ...
          {activeTab === 'charts' && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  <div className="p-2.5 rounded-xl bg-emerald-100 text-emerald-800 group-hover:bg-emerald-600 group-hover:text-white transition-colors mb-2">
                    <BarChart2 className="size-6" />
                  </div>
                  <span className="text-xs font-bold text-slate-800">Colunas</span>
                ...
                >
                  <div className="p-2.5 rounded-xl bg-blue-100 text-blue-800 group-hover:bg-blue-600 group-hover:text-white transition-colors mb-2">
                    <TrendingUp className="size-6" />
                  </div>
                  <span className="text-xs font-bold text-slate-800">Linhas</span>
                ...
                <button
                  ...
                  className="flex flex-col items-center p-3.5 rounded-xl bg-slate-50 hover:bg-amber-50 border border-slate-200 hover:border-amber-300 transition-all text-center group cursor-pointer"
                >
                  <div className="p-2.5 rounded-xl bg-amber-100 text-amber-900 group-hover:bg-amber-600 group-hover:text-white transition-colors mb-2">
                    <PieChart className="size-6" />
                  </div>
                  <span className="text-xs font-bold text-slate-800">Pizza / Rosca</span>
              ...
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Gera relatório multidimensional com agrupamentos dinâmicos, subtotais e filtros cruzados.
                    </p>
                  </div>
                </div>
                ...
                <div className="pt-2 flex gap-3">
                  <button
                    ...
                    className="flex-1 py-2.5 px-4 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-xs"
                  >
                    <Table className="size-4" />
        ...
        <div className="flex items-center justify-between px-6 py-3.5 border-t border-slate-200 bg-slate-50 text-xs text-slate-500">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-300 font-bold transition-colors cursor-pointer"
          >
            <Download className="size-3.5 text-emerald-700" />
            <span>Exportar Seleção para Excel (.XLSX)</span>
          </button>
          <button
            onClick={onClose}
